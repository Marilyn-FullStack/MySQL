...
/*
Em qualqur partye do atributo %string%
no inicio do atributo %string
no final do atributo string%
*/
...
SELECT tb_categorias.descricao as Categoria,
Concat('R$ ', FORMAT (avg (preco),2, 'pt-BR')) as Preço_Médio, count(*) as Total
FROM tb_produtos INNER JOIN tb_categorias 
ON tb_categorias.id = tb_produtos.categoria_id
